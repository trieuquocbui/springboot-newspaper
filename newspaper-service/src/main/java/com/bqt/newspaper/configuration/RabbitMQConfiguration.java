...
public class RabbitMQConfiguration {
    ...
    public static final String NOTIFICATION_CANCELLATION_DIRECT_EXCHANGE = "notification-cancellation-direct-exchange";
    ...
    public static final String NOTIFICATION_CANCELLATION_QUEUE = "notification-cancellation-queue";
    public static final String DELETE_FILE_QUEUE = "delete-file-queue";

    public static final String ROUTING_KEY_NOTIFICATION_CANCELLATION = "notification-cancellation";
    ...
    @Bean
    public DirectExchange deleteNotificationDirectExchange(){return new DirectExchange(NOTIFICATION_CANCELLATION_DIRECT_EXCHANGE);}
    ...
    public Queue deleteNotificationQueue(){
        return new Queue(NOTIFICATION_CANCELLATION_QUEUE);
    }
    ...
    @Bean
    public Binding notificationCancellationBinding() {
        return BindingBuilder.bind(deleteNotificationQueue()).to(deleteNotificationDirectExchange()).with(ROUTING_KEY_NOTIFICATION_CANCELLATION);
    }
