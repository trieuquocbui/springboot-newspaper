...
import com.bqt.newspaer.event.NotificationEvent;
import com.bqt.newspaer.exception.*;
import com.bqt.newspaer.payload.*;
import com.bqt.newspaer.repository.NewspaperRepository;
import com.bqt.newspaer.repository.OriginRepository;
...
public class NewspaperService implements INewspaperService {
    ...
    protected NewspaperResponse convertToNewspaperResponse(Newspaper newspaper){
        ...
        newspaperResponse.setAuthor(newspaper.getAuthor());
