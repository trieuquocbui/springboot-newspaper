...
import com.bqt.newspaer.service.INewspaperService;
...
public class NewspaperController {
    ...
    public ResponseEntity<ApiResponse<PaginationResponse<NewspaperResponse>>> getNewspaperList(
        ...
        if(date != null){
            InfoPage infoPage = new InfoPage(page,limit,sortDir,sortBy,topic,origin,null,date,isHot);
            response = newspaperService.findByNewspaperListByDate(infoPage);
        } else{
            InfoPage infoPage = new InfoPage(page,limit,sortDir,sortBy,topic,origin,search,null,isHot);
    ...
    public ResponseEntity<ApiResponse<NewspaperResponse>> getOrigin(@PathVariable(name = "newspaperId") String newspaperId){
